import { extraLegalContent } from './content-extra';
...
const baseLegalContent: Partial<Record<AppLanguage, LegalLocaleContent>> & { en: LegalLocaleContent } = {
  en: {
...
export const legalContent: Partial<Record<AppLanguage, LegalLocaleContent>> & { en: LegalLocaleContent } = {
  ...baseLegalContent,
  ...extraLegalContent,
};

export function getLegalContent(language: AppLanguage): LegalLocaleContent {
  return legalContent[language] ?? legalContent.en;
}
