...
type PasswordRequirementsProps = {
  password: string;
  tOverride?: Translation;
};

export function PasswordRequirements({ password, tOverride }: PasswordRequirementsProps) {
  const { t: appTranslations } = useAppLanguage();
  const t = tOverride ?? appTranslations;
